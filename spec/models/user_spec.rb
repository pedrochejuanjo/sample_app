...
describe User do
  ...
  describe "email address with mixed casing" do
  ...
  describe "when password is not present" do
  	before do
  		@user = User.new(name: "Example User", email: "example@email.com", password: "", password_confirmation: " ")
  	end
  ...
  describe "return value of authenticate method" do
  	...
  	describe "with invalid password" do
  		let (:user_for_invalid_password) { found_user.authenticate("something") }
